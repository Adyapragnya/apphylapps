...
app.get('/api/sat-intervals', async (req, res) => {
  ...
  async function checkAndUpdateVesselData() {
    try {
        ...
        setTimeout(checkAndUpdateVesselData, 1000 * 60* 60); // Runs the function every minute
    }
}
function sendConsolidatedEmail(vessels) {
    ...
    const mailOptions = {
        ...
        to: 'tech.adyapragnya@gmail.com,support@hylapps.com,tima@wrist.com,miho@wrist.com,aisw@wrist.com',
        subject: 'Hyla-Alert',
